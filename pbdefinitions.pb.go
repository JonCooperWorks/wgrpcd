...
func init() {
	proto.RegisterType((*ChangeListenPortRequest)(nil), "wireguardrpc.ChangeListenPortRequest")
	proto.RegisterType((*ChangeListenPortResponse)(nil), "wireguardrpc.ChangeListenPortResponse")
	proto.RegisterType((*CreatePeerRequest)(nil), "wireguardrpc.CreatePeerRequest")
	proto.RegisterType((*CreatePeerResponse)(nil), "wireguardrpc.CreatePeerResponse")
	proto.RegisterType((*RekeyPeerRequest)(nil), "wireguardrpc.RekeyPeerRequest")
	proto.RegisterType((*RekeyPeerResponse)(nil), "wireguardrpc.RekeyPeerResponse")
	proto.RegisterType((*RemovePeerRequest)(nil), "wireguardrpc.RemovePeerRequest")
	proto.RegisterType((*RemovePeerResponse)(nil), "wireguardrpc.RemovePeerResponse")
	proto.RegisterType((*ListPeersRequest)(nil), "wireguardrpc.ListPeersRequest")
	proto.RegisterType((*ListPeersResponse)(nil), "wireguardrpc.ListPeersResponse")
	proto.RegisterType((*Peer)(nil), "wireguardrpc.Peer")
	proto.RegisterType((*DevicesRequest)(nil), "wireguardrpc.DevicesRequest")
	proto.RegisterType((*DevicesResponse)(nil), "wireguardrpc.DevicesResponse")
}
...
var fileDescriptor_c1700b5ab3a81f98 = []byte{
	...
	,
}
...
func (c *wireguardRPCClient) ChangeListenPort(ctx context.Context, in *ChangeListenPortRequest, opts ...grpc.CallOption) (*ChangeListenPortResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/wireguardrpc.WireguardRPC/ChangeListenPort", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wireguardRPCClient) CreatePeer(ctx context.Context, in *CreatePeerRequest, opts ...grpc.CallOption) (*CreatePeerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/wireguardrpc.WireguardRPC/CreatePeer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wireguardRPCClient) RekeyPeer(ctx context.Context, in *RekeyPeerRequest, opts ...grpc.CallOption) (*RekeyPeerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/wireguardrpc.WireguardRPC/RekeyPeer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wireguardRPCClient) RemovePeer(ctx context.Context, in *RemovePeerRequest, opts ...grpc.CallOption) (*RemovePeerResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/wireguardrpc.WireguardRPC/RemovePeer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wireguardRPCClient) ListPeers(ctx context.Context, in *ListPeersRequest, opts ...grpc.CallOption) (*ListPeersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/wireguardrpc.WireguardRPC/ListPeers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wireguardRPCClient) Devices(ctx context.Context, in *DevicesRequest, opts ...grpc.CallOption) (*DevicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/wireguardrpc.WireguardRPC/Devices", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WireguardRPC_ChangeListenPort_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wireguardrpc.WireguardRPC/ChangeListenPort",
	}
...
func _WireguardRPC_CreatePeer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wireguardrpc.WireguardRPC/CreatePeer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WireguardRPC_RekeyPeer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wireguardrpc.WireguardRPC/RekeyPeer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WireguardRPC_RemovePeer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wireguardrpc.WireguardRPC/RemovePeer",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WireguardRPC_ListPeers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wireguardrpc.WireguardRPC/ListPeers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _WireguardRPC_Devices_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/wireguardrpc.WireguardRPC/Devices",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _WireguardRPC_serviceDesc = grpc.ServiceDesc{
	ServiceName: "wireguardrpc.WireguardRPC",
